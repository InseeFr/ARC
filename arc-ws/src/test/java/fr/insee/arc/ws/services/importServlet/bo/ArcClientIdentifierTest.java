...
public class ArcClientIdentifierTest {
	...
	public void testArcClientIdentifierInitializeClient() throws ArcException {
		...
		JSONObject json = new JSONObject("{\"service\":\"arcClient\", \"client\":\"ARTEMIS\",\"environnement\":\"arc.bas1\",\"familleNorme\":\"DSN\",\"format\":\"csv_gzip\"}");		
	...
	public void testArcClientIdentifierRetrieveClientAttributes() throws ArcException {
		...
		JSONObject json = new JSONObject("{\"service\":\"tableContent\",\"client\":\"arc_bas1.ARTEMIS_1701335653112_nmcl_code_pays_etranger_2015\",\"environnement\":\"arc.bas1\",\"familleNorme\":\"DSN\",\"format\":\"csv_gzip\"}");		
		
		ArcClientIdentifierUnsafe clientParameters = new ArcClientIdentifierUnsafe(json);

		assertEquals("arc_bas1.ARTEMIS_1701335653112_nmcl_code_pays_etranger_2015",clientParameters.getClientInputParameterUnsafe());
		assertEquals("ARTEMIS",clientParameters.getClientIdentifierUnsafe());
