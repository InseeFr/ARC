...
import fr.insee.arc.web.gui.entrepot.model.ViewEntrepot;

public class EntrepotDaoTest extends InitializeQueryTest {

	private static VObjectService vObjectService;
	private static DataObjectService dao;
	private static EntrepotDao pdao;
	...
	@Test
	public void initializeViewEntrepot() {

		VObject viewEntrepot = new ViewEntrepot();
		
		// execute query
		pdao.initializeViewEntrepot(viewEntrepot);

		// test the content of the view
		List<String> viewColumns = ColumnEnum
				.listColumnEnumByName(ViewEnum.IHM_ENTREPOT.getColumns().keySet());
		viewColumns.removeAll(viewEntrepot.getHeadersDLabel());
