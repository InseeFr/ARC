		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md d-flex justify-content-center">
					...
					<h1>
						<s:text name="managementSandbox.header" />
					</h1>
				</div>
			</div>
			<hr />
				...
				<div class="col-md-8">
						...
						<s:iterator value="listePhase" var="phase" status="i">
							<s:if test="isInIhm">
								<button ajax="true" doAction="executerBatch"
									...
									label="<s:property value='nomPhase'/>" name="phaseAExecuter"
					...
					<div class="row">
						<div class="col-md">
							...
							<label for="console" class="mb-0"></label>
						</div>
					</div>
					<div class="row">
						<div class="col-md">
							<s:textarea id="console" name="consoleIhm" class="noselect w-100"
								readonly="true" target="updateConsoleBAS8" theme="simple"></s:textarea>
						</div>
			...
			<div class="row">
				<div class="col-md-3 border-right" id="viewEntrepotBAS8">
