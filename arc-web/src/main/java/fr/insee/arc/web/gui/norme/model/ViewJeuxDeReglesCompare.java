...
public class ViewJeuxDeReglesCompare extends VObject {
    public ViewJeuxDeReglesCompare() {
        super();
        
        this.setTitle("normManagement.compareRules");

        this.setSessionName("viewJeuxDeReglesCompare");
