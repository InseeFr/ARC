package fr.insee.arc.web.webusecases.export.service;
...
import fr.insee.arc.web.webusecases.export.model.ModelExport;


@Service
@Scope(scopeName = WebApplicationContext.SCOPE_REQUEST, proxyMode = ScopedProxyMode.TARGET_CLASS)
public class HubServiceExport extends ArcWebGenericService<ModelExport>  {

	protected static final String RESULT_SUCCESS = "/jsp/gererExport.jsp";

	private static final Logger LOGGER = LogManager.getLogger(HubServiceExport.class);
