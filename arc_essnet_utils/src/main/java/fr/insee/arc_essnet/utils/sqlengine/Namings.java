...
import fr.insee.arc_essnet.utils.sqlengine.model.DefaultAttribute;
import fr.insee.arc_essnet.utils.sqlengine.model.IAttribute;
import fr.insee.arc_essnet.utils.sqlengine.model.IToken;
import fr.insee.arc_essnet.utils.sqlengine.model.IType;
import fr.insee.arc_essnet.utils.sqlengine.model.PostgreSQLTypes;
import fr.insee.arc_essnet.utils.sqlengine.model.SQLTable;
import fr.insee.arc_essnet.utils.sqlengine.model.TempNameSuffix;
import fr.insee.arc_essnet.utils.sqlengine.model.TempNameSuffixShort;
import fr.insee.arc_essnet.utils.textUtils.Untokenizer;
import fr.insee.arc_essnet.utils.utils.LoggerHelper;
import fr.insee.arc_essnet.utils.utils.ManipString;

/**
 *
 * Classe utilitaire qui peut manipuler des noms pour le moteur SQL.
 *
 */
public final class Namings
{
     ...
     * @return ... PROCESSUS
     */
    public static final Naming getDefaultNamingProcessus(String schema, String idCampagne, String idSample,
            String nomPhase, String name)
    {
        return new DefaultNaming(//
                Tokens.TOK_SCHEMA, new StringToken(schema), //
                Tokens.TOK_CAMPAGNE, new StringToken(idCampagne), //
                Tokens.TOK_SAMPLE, new StringToken(idSample), //
                Tokens.TOK_NOM_PHASE, new StringToken(nomPhase), //
