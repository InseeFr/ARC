...
import fr.insee.arc_essnet.core.service.mapping.regles.RegleMappingClePrimaire;
import fr.insee.arc_essnet.core.service.mapping.regles.RegleMappingCorrespondanceFonctionnelle;
import fr.insee.arc_essnet.core.service.mapping.regles.RegleMappingGlobale;
import fr.insee.arc_essnet.core.service.mapping.regles.RegleMappingGroupe;
import fr.insee.arc_essnet.core.service.mapping.regles.AbstractRegleMappingSimple.CodeSQL;
import fr.insee.arc_essnet.core.service.mapping.regles.AbstractRegleMappingSimple.RubriqueMapping;
...
public class RegleMappingFactory {
    ...
    public AbstractRegleMapping get(String anExpression, VariableMapping aVariableMapping) {
         ...
         */
        else if (anExpression.matches(CodeSQL.regexRegleCodeSQL)) {
