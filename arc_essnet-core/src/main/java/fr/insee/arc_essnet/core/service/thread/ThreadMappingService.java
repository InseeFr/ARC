...
import fr.insee.arc_essnet.core.dao.JeuDeRegleDao;
...
import fr.insee.arc_essnet.core.service.ServiceCommunFiltrageMapping;
import fr.insee.arc_essnet.core.service.mapping.MappingService;
import fr.insee.arc_essnet.core.service.mapping.RegleMappingFactory;
import fr.insee.arc_essnet.core.service.mapping.RequeteMapping;
import fr.insee.arc_essnet.core.service.mapping.RequeteMappingCalibree;
...
public class ThreadMappingService extends AbstractThreadService {
	...
	this.tableTempFiltrageOk = temporaryTableName(this.getEnvExecution(), this.tokenInputPhaseName,
		"temp_filtrage_ok");
	...
	List<RuleSets> listeJeuxDeRegles = JeuDeRegleDao.recupJeuDeRegle(this.connection, this.tableTempFiltrageOk,
        ...
        for (int i = 0; i < listeJeuxDeRegles.size(); i++) {
            ...
            RequeteMapping requeteMapping = new RequeteMapping(this.connection, this.regleMappingFactory, idFamille, listeJeuxDeRegles.get(i),
                    this.getEnvExecution(), this.tableTempFiltrageOk);
            /*
...
//            LoggerDispatcher.info("Exécution du mapping", LOGGER);
	...
	return new RegleMappingFactory(this.connection, this.getEnvExecution(), ensembleIdentifiantRubriqueExistante,
