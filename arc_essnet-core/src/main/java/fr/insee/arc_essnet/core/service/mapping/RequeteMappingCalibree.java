...
import fr.insee.arc_essnet.utils.bdd.AbstractRequeteSQLCalibree;
import fr.insee.arc_essnet.utils.bdd.RequeteSQLCalibree;
 ...
 *
 */
public class RequeteMappingCalibree extends AbstractRequeteSQLCalibree  {
    ...
    private String getRequeteUpdatePilotageKO(String aNomFichier) {
        return new StringBuilder("UPDATE " + this.nomTablePilotage)//
                .append("\n  SET etat_traitement='{" + TraitementState.KO + "}', rapport='Erreur SQL : '||message")//
    ...
    protected void execute() throws SQLException {
        StringBuilder executed = new StringBuilder("DO").append("\n$MAPPING$").append("\nDECLARE").append("\nmessage text;").append("\nBEGIN")//
                ...
                .append("\nEND;").append("\n$MAPPING$;");
        UtilitaireDao.get(DbConstant.POOL_NAME).executeBlock(this.getConnexion(), executed);
    ...
    public StringBuilder buildQuery(String aRequete, List<String> args) {
        ...
        StringBuilder returned = new StringBuilder("BEGIN")//
                .append("\nmessage := '';")//
                .append("\nEXECUTE '")//
                .append(aRequete.replace(QUOTE, QUOTE_QUOTE))//
