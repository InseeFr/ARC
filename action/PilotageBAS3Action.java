...
@Component
@Results({ @Result(name = "success", location = "/jsp/gererPilotageBAS3.jsp"), @Result(name = "index", location = "/jsp/index.jsp") })
public class PilotageBAS3Action implements SessionAware {

	private String envExecution="arc_BAS3";
	
    @Override
    public void setSession(Map<String, Object> session) {
        this.viewEntrepotBAS3.setMessage("");
        this.viewPilotageBAS3.setMessage("");
        this.viewRapportBAS3.setMessage("");
        this.viewFichierBAS3.setMessage("");
        this.viewArchiveBAS3.setMessage("");
    }

    private static final Logger logger = Logger.getLogger(PilotageBAS3Action.class);

    @Autowired
    @Qualifier("viewPilotageBAS3")
    VObject viewPilotageBAS3;

    @Autowired
    @Qualifier("viewRapportBAS3")
    VObject viewRapportBAS3;

    @Autowired
    @Qualifier("viewFichierBAS3")
    VObject viewFichierBAS3;

    @Autowired
    @Qualifier("viewEntrepotBAS3")
    VObject viewEntrepotBAS3;

    @Autowired
    @Qualifier("viewArchiveBAS3")
    VObject viewArchiveBAS3;
    ...
    public String sessionSyncronize() {
        ...
        this.viewPilotageBAS3.setActivation(this.scope);
        this.viewRapportBAS3.setActivation(this.scope);
        this.viewFichierBAS3.setActivation(this.scope);
        this.viewEntrepotBAS3.setActivation(this.scope);
        this.viewArchiveBAS3.setActivation(this.scope);

        Boolean defaultWhenNoScope = true;

        if (this.viewPilotageBAS3.getIsScoped()) {
            initializePilotageBAS3();
            defaultWhenNoScope = false;
        }

        if (this.viewRapportBAS3.getIsScoped()) {
            initializeRapportBAS3();
            defaultWhenNoScope = false;
        }

        if (this.viewFichierBAS3.getIsScoped()) {
            initializeFichierBAS3();
            defaultWhenNoScope = false;
        }

        if (this.viewEntrepotBAS3.getIsScoped()) {
            initializeEntrepotBAS3();
            defaultWhenNoScope = false;
        }

        if (this.viewArchiveBAS3.getIsScoped()) {
            initializeArchiveBAS3();
            defaultWhenNoScope = false;
        }

        if (defaultWhenNoScope) {
            System.out.println("default");
            this.viewPilotageBAS3.setIsActive(true);
            this.viewPilotageBAS3.setIsScoped(true);

            this.viewRapportBAS3.setIsActive(true);
            this.viewRapportBAS3.setIsScoped(true);

            this.viewEntrepotBAS3.setIsActive(true);
            this.viewEntrepotBAS3.setIsScoped(true);
    ...
    public void initializeEntrepotBAS3() {
        System.out.println("/* initializeEntrepotBAS3 */");
        ...
        // this.viewEntrepotBAS3.setColumnRendering(ArcConstantVObjectGetter.columnRender.get(this.viewEntrepotBAS3.getSessionName()));
        this.viewEntrepotBAS3.initialize(requete.toString(), null, defaultInputFields);
    }

    // private SessionMap session;

    // visual des Pilotages du bac à sable
    public void initializePilotageBAS3() {
    	VObjectUtil.initializeVObjectPilotage(viewPilotageBAS3, envExecution);
    }

    @Action(value = "/selectPilotageBAS3")
    public String selectPilotageBAS3() {
        return sessionSyncronize();
    }

    @Action(value = "/sortPilotageBAS3")
    public String sortPilotageBAS3() {
        this.viewPilotageBAS3.sort();
        return sessionSyncronize();

    }

    // visual des Pilotages du bac à sable
    public void initializeRapportBAS3() {
    	VObjectUtil.initializeVObjectRapport(viewRapportBAS3, envExecution);
    }

    @Action(value = "/selectRapportBAS3")
    public String selectRapportBAS3() {
        return sessionSyncronize();
    }

    @Action(value = "/sortRapportBAS3")
    public String sortRapportBAS3() {
        this.viewRapportBAS3.sort();
        return sessionSyncronize();
    ...
    @Action(value = "/filesUploadBAS3")
    public String filesUploadBAS3() {

        System.out.println("/* filesUploadBAS3 : " + this.viewEntrepotBAS3.getCustomValues() + " */");

        if (this.viewEntrepotBAS3.getCustomValues() != null && !this.viewEntrepotBAS3.getCustomValues().get("entrepotEcriture").equals("")
                && this.viewPilotageBAS3.getFileUploadFileName() != null) {
            String repertoireUpload = this.repertoire + "ARC_BAS3" + File.separator + TraitementPhase.RECEPTION + "_"
                    + this.viewEntrepotBAS3.getCustomValues().get("entrepotEcriture");
            System.out.println(repertoireUpload);

            this.viewPilotageBAS3.upload(repertoireUpload);
        } else {
            String msg = "";
            if (this.viewPilotageBAS3.getFileUploadFileName() == null) {
                msg = "Erreur : aucun fichier selectionné\n";
                this.viewPilotageBAS3.setMessage("Erreur : aucun fichier selectionné.");
            }
            ...
            this.viewPilotageBAS3.setMessage(msg);
        }
        this.viewEntrepotBAS3.getCustomValues().put("entrepotEcriture", null);
     ...
     */
    public void initializeArchiveBAS3() {
        System.out.println("/* initializeArchiveBAS3 */");
        if (this.viewEntrepotBAS3.getCustomValues().containsKey("entrepotLecture")
                && !this.viewEntrepotBAS3.getCustomValues().get("entrepotLecture").equals("")) {
            HashMap<String, String> defaultInputFields = new HashMap<String, String>();
            StringBuilder requete = new StringBuilder();

            requete.append("select * from "+ApiService.dbEnv(this.envExecution)+"pilotage_archive where entrepot='"
                    + this.viewEntrepotBAS3.getCustomValues().get("entrepotLecture") + "'");
            // this.viewArchiveBAS3.setColumnRendering(ArcConstantVObjectGetter.columnRender.get(this.viewArchiveBAS3.getSessionName()));
            this.viewArchiveBAS3.initialize(requete.toString(), null, defaultInputFields);
        } else {

            this.viewArchiveBAS3.destroy();
        }
    }
     ...
     * @return
     */
    @Action(value = "/visualiserEntrepotBAS3")
    public String visualiserEntrepotBAS3() {
        return sessionSyncronize();
   }
     ...
     * @return
     */
    @Action(value = "/downloadEnveloppeFromArchiveBAS3")
    public String downloadEnveloppeFromArchiveBAS3() {
        ...
        HashMap<String, ArrayList<String>> selection = this.viewArchiveBAS3.mapContentSelected();

        StringBuilder querySelection = new StringBuilder();
        querySelection.append("select distinct alias_de_table.nom_archive as nom_fichier from (" + this.viewArchiveBAS3.getMainQuery()
                + ") alias_de_table ");
        querySelection.append(this.viewArchiveBAS3.buildFilter(this.viewArchiveBAS3.getFilterFields(), this.viewArchiveBAS3.getHeadersDLabel()));
        ...
        try {
            g = new GenericBean(UtilitaireDao.get("arc").executeRequest(null,
                    "SELECT DISTINCT entrepot FROM (" + this.viewArchiveBAS3.getMainQuery() + ") alias_de_table "));
        ...
        String chemin = this.repertoire + File.separator + "ARC_BAS3";
        this.viewArchiveBAS3.downloadEnveloppe(querySelection.toString(), chemin, listRepertoire);
        return "none";
    }

    @Action(value = "/startInitialisationBAS3")
    public String startInitialisationBAS3() {
    ...
    @Action(value = "/startChargementBAS3")
    public String startChargementBAS3() {
        LoggerDispatcher.trace("startChargementBAS3", logger);
    ...
    @Action(value = "/startNormageBAS3")
    public String startNormageBAS3() {
        ApiInitialisationService.synchroniserSchemaExecution(null, "arc.ihm", this.envExecution);
    ...
    @Action(value = "/startControleBAS3")
    public String startControleBAS3() {
        ApiInitialisationService.synchroniserSchemaExecution(null, "arc.ihm", this.envExecution);
    ...
    @Action(value = "/startFiltrageBAS3")
    public String startFiltrageBAS3() {
        ApiInitialisationService.synchroniserSchemaExecution(null, "arc.ihm", this.envExecution);
    ...
    @Action(value = "/startMappingBAS3")
    public String startMappingBAS3() {
        ApiInitialisationService.synchroniserSchemaExecution(null, "arc.ihm", this.envExecution);
    ...
    public String undoFilesSelection() {
    	...
    	HashMap<String,ArrayList<String>> m=viewFichierBAS3.mapContentSelected();
    ...
    // Bouton undo
    @Action(value = "/undoChargementBAS3")
    public String undoChargementBAS3() {
        // String repertoire=ServletActionContext.getServletContext().getRealPath("/");
    ...
    @Action(value = "/undoNormageBAS3")
    public String undoNormageBAS3() {
        // String repertoire=ServletActionContext.getServletContext().getRealPath("/");
        ApiInitialisationService serv = new ApiInitialisationService(TraitementPhase.INITIALISATION.toString(), "arc.ihm", this.envExecution,
                this.repertoire, TraitementPhase.INITIALISATION.getNbLigneATraiter());
        try {
    ...
    @Action(value = "/undoControleBAS3")
    public String undoControleBAS3() {
        // String repertoire=ServletActionContext.getServletContext().getRealPath("/");
        ApiInitialisationService serv = new ApiInitialisationService(TraitementPhase.INITIALISATION.toString(), "arc.ihm", this.envExecution,
                this.repertoire, TraitementPhase.INITIALISATION.getNbLigneATraiter());
        try {
    ...
    @Action(value = "/undoFiltrageBAS3")
    public String undoFiltrageBAS3() {
        // String repertoire=ServletActionContext.getServletContext().getRealPath("/");
        ApiInitialisationService serv = new ApiInitialisationService(TraitementPhase.INITIALISATION.toString(), "arc.ihm", this.envExecution,
                this.repertoire, TraitementPhase.INITIALISATION.getNbLigneATraiter());
        try {
    ...
    @Action(value = "/undoMappingBAS3")
    public String undoMappingBAS3() {
        // String repertoire=ServletActionContext.getServletContext().getRealPath("/");
        ApiInitialisationService serv = new ApiInitialisationService(TraitementPhase.INITIALISATION.toString(), "arc.ihm", this.envExecution,
                this.repertoire, TraitementPhase.INITIALISATION.getNbLigneATraiter());
        try {
    ...
    @Action(value = "/resetBAS3")
    public String resetBAS3() {
        try {
            ApiInitialisationService.clearPilotageAndDirectories(this.repertoire, this.envExecution);
        } catch (Exception e) {
            e.printStackTrace();
            viewPilotageBAS3.setMessage("Problème : " + e.getMessage());
        }
    ...
    // visual des Fichiers
    public void initializeFichierBAS3() {
        HashMap<String, ArrayList<String>> selectionLigne = this.viewPilotageBAS3.mapContentSelected();
        ArrayList<String> selectionColonne = this.viewPilotageBAS3.listHeadersSelected();

        HashMap<String, ArrayList<String>> selectionLigneRapport = this.viewRapportBAS3.mapContentSelected();

        if (!selectionLigne.isEmpty() && !selectionColonne.isEmpty()) {
            System.out.println("/* initializeFichierBAS3 */");
            ...
            // this.viewFichierBAS3.setColumnRendering(ArcConstantVObjectGetter.columnRender.get(this.viewFichierBAS3.getSessionName()));
            this.viewFichierBAS3.initialize(requete.toString(), null, defaultInputFields);
        } else if (!selectionLigneRapport.isEmpty()) {
            System.out.println("/* initializeFichierBAS3 */");

            HashMap<String, String> type = this.viewRapportBAS3.mapHeadersType();
            HashMap<String, String> defaultInputFields = new HashMap<String, String>();
            ...
            this.viewFichierBAS3.destroy();
        }
    }

    @Action(value = "/selectFichierBAS3")
    public String selectFichierBAS3() {
        return sessionSyncronize();
    }

    @Action(value = "/sortFichierBAS3")
    public String sortFichierBAS3() {
        this.viewFichierBAS3.sort();
        return sessionSyncronize();

    }

    @Action(value = "/downloadFichierBAS3")
    public String downloadFichierBAS3() {
        LoggerDispatcher.trace("*** Téléchargement des fichiers ***", logger);
        // récupération de la liste des id_source

        HashMap<String, ArrayList<String>> selection = this.viewFichierBAS3.mapContentSelected();
        StringBuilder querySelection = this.viewFichierBAS3.queryView();
        ...
        // String repertoire= ServletActionContext.getServletContext().getRealPath("/");
        this.viewFichierBAS3.downloadXML(querySelection.toString(), this.repertoire, this.envExecution, TraitementPhase.RECEPTION.toString(),
    ...
    @Action(value = "/downloadBdBAS3")
    public String downloadBdBAS3() {
        ...
        for (int k = 0; k < tableDownload.size(); k++) {
            ...
            if (!this.viewFichierBAS3.mapContentSelected().isEmpty()) {
                ArrayList<String> filesSelected = this.viewFichierBAS3.mapContentSelected().get("id_source");
        ...
        this.viewFichierBAS3.download(fileNames, tableauRequete);

        return "none";

    }

    @Action(value = "/downloadEnveloppeBAS3")
    public String downloadEnveloppeBAS3() {
        LoggerDispatcher.trace("*** Téléchargement des enveloppes ***", logger);
        // récupération de la liste des noms d'enloppe
        HashMap<String, ArrayList<String>> selection = this.viewFichierBAS3.mapContentSelected();

        StringBuilder querySelection = new StringBuilder();
        querySelection.append("select distinct alias_de_table.container as nom_fichier from (" + this.viewFichierBAS3.getMainQuery()
                + ") alias_de_table ");
        querySelection.append(this.viewFichierBAS3.buildFilter(this.viewFichierBAS3.getFilterFields(), this.viewFichierBAS3.getHeadersDLabel()));
        ...
        String chemin = this.repertoire + File.separator + "ARC_BAS3";
        this.viewFichierBAS3.downloadEnveloppe(querySelection.toString(), chemin, listRepertoire);
     ...
     * @return
     */
    @Action(value = "/toDeleteBAS3")
    public String toDeleteBAS3() {
        ...
        StringBuilder querySelection = new StringBuilder();
        querySelection.append("select distinct container, id_source from (" + this.viewFichierBAS3.getMainQuery() + ") alias_de_table ");
        querySelection.append(this.viewFichierBAS3.buildFilter(this.viewFichierBAS3.getFilterFields(), this.viewFichierBAS3.getHeadersDLabel()));
        ...
        this.viewPilotageBAS3.setMessage(message);
     ...
     * @return
     */
    @Action(value = "/undoActionBAS3")
    public String undoActionBAS3() {
     ...
     * @return
     */
    @Action(value = "/toRestoreBAS3")
    public String toRestoreBAS3() {
     ...
     * @return
     */
    @Action(value = "/toRestoreArchiveBAS3")
    public String toRestoreArchiveBAS3() {
        LoggerDispatcher.trace("*** Marquage de fichier à rejouer ***", logger);
        HashMap<String, ArrayList<String>> selection = this.viewFichierBAS3.mapContentSelected();
        // System.out.println(selection);
     ...
     * @return
     */
    @Action(value = "/resetPhaseBAS3")
    public String resetPhaseBAS3() {
        HashMap<String, ArrayList<String>> selection = this.viewFichierBAS3.mapContentSelected();
        StringBuilder querySelection = this.viewFichierBAS3.queryView();
        ...
        String phase = this.viewFichierBAS3.mapContent().get("phase_traitement").get(0);
    ...
    public VObject getViewPilotageBAS3() {
        return this.viewPilotageBAS3;
    }

    public void setViewPilotageBAS3(VObject viewPilotageBAS3) {
        this.viewPilotageBAS3 = viewPilotageBAS3;
    }

    public VObject getViewRapportBAS3() {
        return this.viewRapportBAS3;
    }

    public void setViewRapportBAS3(VObject viewRapportBAS3) {
        this.viewRapportBAS3 = viewRapportBAS3;
    }

    public VObject getViewFichierBAS3() {
        return this.viewFichierBAS3;
    }

    public void setViewFichierBAS3(VObject viewFichierBAS3) {
        this.viewFichierBAS3 = viewFichierBAS3;
    }

    public VObject getViewEntrepotBAS3() {
        return this.viewEntrepotBAS3;
    }

    public void setViewEntrepotBAS3(VObject viewEntrepotBAS3) {
        this.viewEntrepotBAS3 = viewEntrepotBAS3;
    }

    public VObject getViewArchiveBAS3() {
        return this.viewArchiveBAS3;
    }

    public void setViewArchiveBAS3(VObject viewArchiveBAS3) {
        this.viewArchiveBAS3 = viewArchiveBAS3;
    }

    /**
     * Mise à jour de la console dans l'objet struts2
     */
    @Action(value = "/resetConsoleBAS3")
    public String resetConsoleBAS3() {
        HttpSession session = ServletActionContext.getRequest().getSession(false);
        session.setAttribute("console", "");
        return sessionSyncronize();
    }

    @Action(value = "/updateConsoleBAS3")
    public String updateConsoleBAS3() {
        HttpSession session = ServletActionContext.getRequest().getSession(false);
