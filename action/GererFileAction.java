...
public class GererFileAction implements SessionAware, IDbConstant, IConstanteCaractere {
    @Override
    ...
    public String seeDirIn() {
        ...
        HashMap<String,ArrayList<String>> m=this.viewDirIn.mapContentSelected();
        if (!m.isEmpty())
        {
    ...
    public String renameIn() {
          HashMap<String,ArrayList<String>> m=this.viewDirIn.mapContentBeforeUpdate();
          HashMap<String,ArrayList<String>> n=this.viewDirIn.mapContentAfterUpdate();
    ...
    public String seeDirOut() {
        ...
        HashMap<String,ArrayList<String>> m=this.viewDirOut.mapContentSelected();
...
//        System.out.println(m);
    ...
    public String renameOut() {
          HashMap<String,ArrayList<String>> m=this.viewDirOut.mapContentBeforeUpdate();
          HashMap<String,ArrayList<String>> n=this.viewDirOut.mapContentAfterUpdate();
