...
import fr.insee.arc_composite.web.model.ViewArchivePROD;
import fr.insee.arc_composite.web.model.ViewEntrepotPROD;
import fr.insee.arc_composite.web.model.ViewFichierPROD;
import fr.insee.arc_composite.web.model.ViewPilotagePROD;
import fr.insee.arc_composite.web.model.ViewRapportPROD;
...
public class PilotagePRODAction implements SessionAware {
    ...
    public void initializePilotagePROD() {
    	VObjectUtil.initializeVObjectPilotage(viewPilotagePROD, envExecution);
    }
    ...
    public void initializeRapportPROD() {
    	VObjectUtil.initializeVObjectRapport(viewRapportPROD, envExecution);
    }
    ...
    public String downloadEnveloppeFromArchivePROD() {
        ...
        HashMap<String, ArrayList<String>> selection = this.viewArchivePROD.mapContentSelected();
...
//    }
    ...
    public void initializeFichierPROD() {
        HashMap<String, ArrayList<String>> selectionLigne = this.viewPilotagePROD.mapContentSelected();
        ArrayList<String> selectionColonne = this.viewPilotagePROD.listHeadersSelected();

        HashMap<String, ArrayList<String>> selectionLigneRapport = this.viewRapportPROD.mapContentSelected();
    ...
    public String downloadFichierPROD() {
        ...
        HashMap<String, ArrayList<String>> selection = this.viewFichierPROD.mapContentSelected();
