...
CONSTRAINT ihm_chargement_regle_type_fichier_fkey FOREIGN KEY (type_fichier) REFERENCES arc.ext_type_fichier_chargement(id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE 
);
