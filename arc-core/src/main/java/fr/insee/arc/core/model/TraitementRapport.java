...
public enum TraitementRapport {
    ...
    TOUTE_PHASE_ERREUR_SQL("Erreur SQL : "), //
    TOUTE_PHASE_TAUX_ERREUR_SUPERIEUR_SEUIL("Le fichier a été intégralement filtré"), //
    TOUTE_PHASE_AUCUN_ENREGISTREMENT("Le fichier ne possède aucun enregistrement pour cette phase. ");
