...
public enum ViewEnum {
	...
	, EXPORT("export", SchemaEnum.SANDBOX, ColumnEnum.TIMESTAMP_DIRECTORY, ColumnEnum.FILE_NAME, ColumnEnum.ZIP, ColumnEnum.TABLE_TO_EXPORT,
			...
			ColumnEnum.NOMENCLATURE_EXPORT, ColumnEnum.JSON_KEY_VALUE, ColumnEnum.COLUMNS_ARRAY_HEADER, ColumnEnum.COLUMNS_ARRAY_VALUE, ColumnEnum.ETAT) //
	...
	, VIEW_MAPPING_DATA_TEMP("vmd", SchemaEnum.TEMPORARY)
