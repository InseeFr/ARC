...
public class DuplicationRulesRegleQueryBuilder {
	 ...
	 * @throws ArcException
	 */
	public static void ajouterRegleDuplication(Map<String, List<String>> regle, String norme, Date validite,
	...
	public static String appliquerRegleDuplication(Map<String, List<String>> regle, String norme, Date validite,
