...
public class ApiChargementService extends ApiService {
    ...
    public void executer() throws ArcException {
        ...
        this.directoryIn = FileSystemManagement.directoryPhaseEtatOK(this.getDirectoryRoot(), this.envExecution, TraitementPhase.valueOf(previousPhase)) + File.separator;
