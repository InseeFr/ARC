package fr.insee.arc.core.service.p4controle;
 ...
 * 3- Pour chaque fichier, determiner son format de lecture (zip, tgz, raw) et
 * le chargeur à utlisé (voir entrepot)</br>
 ...
 * 4-3 Fin du parsing. Constituer la requete de mise en relation des données
 * chargées et la stocker pour son utilisation ultérieure au normage</br>
 * 5- Fin chargement. Insertion dans la table applicative CHARGEMENT_OK. Mise à
 * jour de la table de pilotage</br>
 *
...
public class ApiControleService extends ApiService {
	...
	public ApiControleService(String aCurrentPhase, String aEnvExecution, String aDirectoryRoot, Integer aNbEnr,
			String paramBatch) {
