...
public class MappingRulesOperationTest {
	...
	public void fillMappingRulesTest() throws ArcException {
		...
		query.build("CREATE TABLE arc_bas1.mapping_regle (\r\n"
				...
				+ ");");
		query.build(SQL.INSERT_INTO, "arc_bas1.mapping_regle", SQL.VALUES, "(1, 'TEST', '2020-01-01', '2025-01-01', 'v01', 'A', 'col_sortie', 'col1', '')", SQL.END_QUERY);
		// hors calendrier
		query.build(SQL.INSERT_INTO, "arc_bas1.mapping_regle", SQL.VALUES, "(1, 'TEST', '1998-01-01', '2020-01-01', 'v01', 'A', 'col_invalid', 'col_invalid', '')", SQL.END_QUERY);
		// norme différente
		query.build(SQL.INSERT_INTO, "arc_bas1.mapping_regle", SQL.VALUES, "(1, 'FAKE_NORM', '2020-01-01', '2025-01-01', 'v01', 'A', 'col_invalid', 'col_invalid', '')", SQL.END_QUERY);
		// périodicité différente
		query.build(SQL.INSERT_INTO, "arc_bas1.mapping_regle", SQL.VALUES, "(1, 'TEST', '2020-01-01', '2025-01-01', 'v01', 'M', 'col_invalid', 'col_invalid', '')", SQL.END_QUERY);
