...
public class RegleMappingGroupeTest {
	...
	private void initializeTest()
	{
		...
		MappingQueriesFactory mappingQueriesFactory = new MappingQueriesFactory(null, "arc_bas2", anEnsembleIdentifiantRubriqueExistante, anEnsembleNomRubriqueExistante);
