...
public class ViewFichierBAS8 extends VObject {
    public ViewFichierBAS8() {
        super();
        this.constantVObject = new ConstantVObject(new HashMap<String, ColumnRendering>() {
...

            {
                ...
                put("generation_composite", new ColumnRendering(false, "generation_composite XML", "80px", "text", null, true));
